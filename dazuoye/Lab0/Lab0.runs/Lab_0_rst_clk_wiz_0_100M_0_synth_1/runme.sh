...
HD_PWD='C:/summer_school/dazuoye/Lab0/Lab0.runs/Lab_0_rst_clk_wiz_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_0_rst_clk_wiz_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_0_rst_clk_wiz_0_100M_0.tcl
