...
HD_PWD='C:/summer_school/dazuoye/Lab0/Lab0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_0_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab_0_wrapper.tcl -notrace
