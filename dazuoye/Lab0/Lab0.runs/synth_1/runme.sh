...
HD_PWD='C:/summer_school/dazuoye/Lab0/Lab0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_0_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_0_wrapper.tcl
